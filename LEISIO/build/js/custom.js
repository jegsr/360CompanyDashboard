...
function init_morris_charts() {
    ...
    if ($('#graph_donut').length) {
        ...
        var topClientes = [];
        var requestTopClientes = $.ajax({
            url: "/api/TopClientes?dataIn='2016/04/01'&dataFm='2017/05/03'",
            type: 'GET',
            async: false,
            cache: false,
            timeout: 30000,
            ...
            success: function (data) {
                ...
                for (index in data) {
                    topClientes.push({ label: data[index].NomeCliente, value: data[index].QuantidadeVendida });

                }

                alert(JSON.stringify(topClientes));
            }
